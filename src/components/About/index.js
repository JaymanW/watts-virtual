    ...
    return (
        <div id="About">
            <div className="About-wrapper">
                ...
                <p>If you’re ready to start transforming your web presence, let’s get in <a href="#contact-wrapper">contact</a>.</p>
                <a className="about-btn" href="#Work">SEE OUR WORK</a>
            </div>
        </div>
    )
}
